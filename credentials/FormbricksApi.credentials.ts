...
export class FormbricksApi implements ICredentialType {
  ...
  properties: INodeProperties[] = [
    ...
    },
    {
      ...
      name: "apiKey",
      description:
        'Your Formbricks organization API-Key. You can create a new API-Key in the Organization Settings. Please read our <a href="https://formbricks.com/docs/api/api-key-setup">API Key Docs</a> for more details.',
      type: "string",
